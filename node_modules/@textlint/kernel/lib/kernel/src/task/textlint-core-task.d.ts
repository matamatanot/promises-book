...
import { TextlintFilterRuleContext, TextlintFilterRuleOptions, TextlintFilterRuleReporter, TextlintRuleContext, TextlintRuleContextReportFunction, TextlintRuleOptions, TextlintRuleReporter, TextlintFilterRuleShouldIgnoreFunction, TextlintSourceCode, TextlintMessageFixCommand } from "@textlint/types";
...
export default abstract class TextLintCoreTask extends EventEmitter {
     ...
     */
    tryToGetRuleObject(ruleCreator: TextlintRuleReporter, ruleContext: Readonly<TextlintRuleContext>, ruleOptions?: TextlintRuleOptions): import("../../../types/src").TextlintRuleReportHandler;
    /**
     * try to get filter rule object
     */
    tryToGetFilterRuleObject(ruleCreator: TextlintFilterRuleReporter, ruleContext: Readonly<TextlintFilterRuleContext>, ruleOptions?: TextlintFilterRuleOptions): import("../../../types/src").TextlintFilterRuleReportHandler;
    /**
