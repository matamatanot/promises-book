...
var textlint_package_name_util_1 = require("./textlint-package-name-util");
var package_prefix_1 = require("../config/package-prefix");
...
var TextLintModuleResolver = /** @class */ (function () {
    ...
    TextLintModuleResolver.prototype.resolveRulePackageName = function (packageName) {
        ...
        var fullPackageName = textlint_package_name_util_1.createFullPackageName(package_prefix_1.PackageNamePrefix.rule, packageName);
    ...
    TextLintModuleResolver.prototype.resolveFilterRulePackageName = function (packageName) {
        var baseDir = this.baseDirectory;
        var fullPackageName = textlint_package_name_util_1.createFullPackageName(package_prefix_1.PackageNamePrefix.filterRule, packageName);
    ...
    TextLintModuleResolver.prototype.resolvePluginPackageName = function (packageName) {
        var baseDir = this.baseDirectory;
        var fullPackageName = textlint_package_name_util_1.createFullPackageName(package_prefix_1.PackageNamePrefix.plugin, packageName);
    ...
    TextLintModuleResolver.prototype.resolvePresetPackageName = function (packageName) {
        var baseDir = this.baseDirectory;
        var PREFIX = package_prefix_1.PackageNamePrefix.rulePreset;
        /* Implementation Note
        ...
        var packageNameWithoutPreset = packageName
            .replace(/^preset-/, "")
            .replace(/^@([^/]+)\/preset-(.*)$/, "@$1/$2");
        var fullPackageName = textlint_package_name_util_1.createFullPackageName(PREFIX, packageNameWithoutPreset);
    ...
    TextLintModuleResolver.prototype.resolveConfigPackageName = function (packageName) {
        var baseDir = this.baseDirectory;
        var fullPackageName = textlint_package_name_util_1.createFullPackageName(package_prefix_1.PackageNamePrefix.config, packageName);
