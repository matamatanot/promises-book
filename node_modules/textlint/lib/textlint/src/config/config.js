...
var Config = /** @class */ (function () {
    ...
    function Config(options) {
         ...
         */
        this.disabledRules = applyNormalizerToList(types_1.normalizeTextlintRuleKey, options.disabledRules ? options.disabledRules : defaultOptions.disabledRules);
        /**
         * @type {string[]} rule key list
         * rules does not includes disabledRules
         */
        this.rules = applyNormalizerToList(types_1.normalizeTextlintRuleKey, options.rules ? options.rules : defaultOptions.rules).filter(function (ruleName) {
         ...
         * These rule is set `false` to options
         */
        this.disabledFilterRules = applyNormalizerToList(types_1.normalizeTextlintFilterRuleKey, options.disabledFilterRules ? options.disabledFilterRules : defaultOptions.disabledFilterRules);
        /**
         * @type {string[]} filter rule key list
         */
        this.filterRules = applyNormalizerToList(types_1.normalizeTextlintFilterRuleKey, options.filterRules ? options.filterRules : defaultOptions.filterRules).filter(function (ruleName) {
            return !_this.disabledFilterRules.includes(ruleName);
        });
        /**
         * @type {string[]} preset key list
         */
        this.presets = applyNormalizerToList(types_1.normalizeTextlintRulePresetKey, options.presets ? options.presets : defaultOptions.presets);
        // => load plugins
        // this.rules has not contain plugin rules
        // =====================
        this.plugins = applyNormalizerToList(types_1.normalizeTextlintPluginKey, options.plugins ? options.plugins : defaultOptions.plugins);
        this.pluginsConfig = applyNormalizerToConfig(types_1.normalizeTextlintPluginKey, options.pluginsConfig ? options.pluginsConfig : defaultOptions.pluginsConfig);
        // rulesConfig
        ...
        this.rulesConfig = applyNormalizerToConfig(types_1.normalizeTextlintRuleKey, objectAssign({}, presetRulesConfig, options.rulesConfig));
        // filterRulesConfig
        this.filterRulesConfig = applyNormalizerToConfig(types_1.normalizeTextlintFilterRuleKey, options.filterRulesConfig || defaultOptions.filterRulesConfig);
        /**
         * @type {string[]}
         */
    ...
    Config.initWithAutoLoading = function (options) {
        ...
        var loadedResult = typeof options.textlintrc === "undefined" || options.textlintrc
            ? config_loader_1.loadConfig(options.configFile, {
